pipeline{
    ...
    stages{
        ...
        stage("Checkout from SCM"){
            steps {
                git branch: 'main', credentialsId: 'github', url: 'https://github.com/Mykulle/GitOps-CI-CD-Pipeline'
            }
        }   
        ...
        stage("Push the changed deployment file to Git"){
            steps{
                ...
                withCredentials([gitUsernamePassword(credentialsId: 'github', gitToolName: 'Default')]) {
                    sh "git push https://github.com/Mykulle/GitOps-CI-CD-Pipeline main"
                }
            }
        }
    }
